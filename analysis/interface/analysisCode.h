...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   vector<Float_t>   *jets_btag_deepCSV;
   vector<Float_t>   *jets_btag_deepFlavor;
   vector<Int_t>     *jets_flav;
   vector<Int_t>     *jets_isH;
   ...
   Int_t           njetsBHadFlav;
   Int_t           njetsCHadFlav;
   vector<Float_t>   *jets_jecUnc;
   Float_t         dau1_jecUnc;
   Float_t         dau2_jecUnc;
   Float_t         bjet1_jecUnc;
   Float_t         bjet2_jecUnc;
   vector<Float_t>   *leps_pt;
   vector<Float_t>   *leps_eta;
   vector<Float_t>   *leps_phi;
   vector<Float_t>   *leps_e;
   vector<Int_t>     *leps_flav;
   Int_t           nleps;
   ...
   Float_t         BDT_HT20_jetdown;
   Float_t         BDT_HT20_jetup;
   Float_t         BDT_HT20_jetdownTot;
   Float_t         BDT_HT20_jetupTot;
...
void analysisCode::Init(TTree *tree)
{
   ...
   bTagweightT = 0;
   TTtopPtreweight = 0;
   TTtopPtreweight_up = 0;
   TTtopPtreweight_down = 0;
   trigSF = 0;
   trigSF_single = 0;
   trigSF_cross = 0;
   VBFtrigSF = 0;
   ...
   IdAndIsoSF_MVA = 0;
   IdAndIsoSF_deep = 0;
   IdAndIsoAndFakeSF_MVA = 0;
   IdAndIsoAndFakeSF_deep = 0;
   DYscale_LL = 0;
   DYscale_MM = 0;
   nBhadrons = 0;
   lheNOutPartons = 0;
   ...
   dau1_deepTauVsEle = 0;
   dau1_deepTauVsMu = 0;
   dau1_photonPtSumOutsideSignalCone = 0;
   dau1_byLooseCombinedIsolationDeltaBetaCorr3Hits = 0;
   dau1_byMediumCombinedIsolationDeltaBetaCorr3Hits = 0;
   dau1_byTightCombinedIsolationDeltaBetaCorr3Hits = 0;
   dau1_pt = 0;
   dau1_eta = 0;
   dau1_phi = 0;
   dau1_e = 0;
   ...
   dau2_deepTauVsEle = 0;
   dau2_deepTauVsMu = 0;
   dau2_photonPtSumOutsideSignalCone = 0;
   dau2_byLooseCombinedIsolationDeltaBetaCorr3Hits = 0;
   dau2_byMediumCombinedIsolationDeltaBetaCorr3Hits = 0;
   dau2_byTightCombinedIsolationDeltaBetaCorr3Hits = 0;
   dau2_pt = 0;
   dau2_eta = 0;
   dau2_phi = 0;
   dau2_e = 0;
   ...
   fatjet_e = 0;
   fatjet_bID = 0;
   fatjet_bID_deepCSV = 0;
   fatjet_bID_deepFlavor = 0;
   fatjet_filteredMass = 0;
   fatjet_prunedMass = 0;
   fatjet_trimmedMass = 0;
   ...
   subjetjet1_e = 0;
   subjetjet1_bID = 0;
   subjetjet1_bID_deepCSV = 0;
   subjetjet1_bID_deepFlavor = 0;
   subjetjet2_pt = 0;
   subjetjet2_eta = 0;
   subjetjet2_phi = 0;
   subjetjet2_e = 0;
   subjetjet2_bID = 0;
   subjetjet2_bID_deepCSV = 0;
   subjetjet2_bID_deepFlavor = 0;
   genjet1_pt = 0;
   genjet1_eta = 0;
   genjet1_phi = 0;
   genjet1_e = 0;
   ...
   tauH_SVFIT_METphi = 0;
   tauH_SVFIT_METrho = 0;
   tauH_SVFIT_mass_up = 0;
   tauH_SVFIT_mass_down = 0;
   tauH_SVFIT_mass_METup = 0;
   tauH_SVFIT_mass_METdown = 0;
   bH_pt = 0;
   bH_eta = 0;
   bH_phi = 0;
   bH_e = 0;
   ...
   ditau_deltaR = 0;
   dib_deltaR = 0;
   ditau_deltaR_per_tauHsvfitpt = 0;
   dib_deltaR_per_bHpt = 0;
   btau_deltaRmin = 0;
   btau_deltaRmax = 0;
   dau1MET_deltaphi = 0;
   dau2MET_deltaphi = 0;
   ...
   bH_mass_raw = 0;
   HHKin_mass_raw = 0;
   HHKin_mass_raw_chi2 = 0;
   HHKin_mass_raw_convergence = 0;
   HHKin_mass_raw_prob = 0;
   HHKin_mass_raw_copy = 0;
   lheht = 0;
   topReweight = 0;
   VBFjet1_pt = 0;
   VBFjet1_eta = 0;
   ...
   VBFjet1_e = 0;
   VBFjet1_btag = 0;
   VBFjet1_btag_deepCSV = 0;
   VBFjet1_btag_deepFlavor = 0;
   VBFjet1_flav = 0;
   VBFjet1_hasgenjet = 0;
   VBFgenjet1_pt = 0;
   VBFgenjet1_eta = 0;
   ...
   VBFjet2_e = 0;
   VBFjet2_btag = 0;
   VBFjet2_btag_deepCSV = 0;
   VBFjet2_btag_deepFlavor = 0;
   VBFjet2_flav = 0;
   VBFjet2_hasgenjet = 0;
   VBFgenjet2_pt = 0;
   VBFgenjet2_eta = 0;
   ...
   jet5_VBF_e = 0;
   jet5_VBF_btag = 0;
   jet5_VBF_btag_deepCSV = 0;
   jet5_VBF_btag_deepFlavor = 0;
   jet5_VBF_flav = 0;
   jet5_VBF_hasgenjet = 0;
   jet5_VBF_z = 0;
   genjet5_VBF_pt = 0;
   genjet5_VBF_eta = 0;
   genjet5_VBF_phi = 0;
   ...
   bH_MET_deltaEta = 0;
   bH_MET_deltaR = 0;
   bH_tauH_MET_deltaR = 0;
   ditau_deltaR_per_tauH_MET_pt = 0;
   p_zeta = 0;
   p_zeta_visible = 0;
   mT_tauH_MET = 0;
   mT_tauH_SVFIT_MET = 0;
   mT_total = 0;
   BDT_ditau_deltaPhi = 0;
   BDT_dib_abs_deltaPhi = 0;
   BDT_dib_deltaPhi = 0;
   BDT_dau1MET_deltaPhi = 0;
   BDT_tauHsvfitMet_abs_deltaPhi = 0;
   BDT_tauHsvfitMet_deltaPhi = 0;
   BDT_bHMet_deltaPhi = 0;
   BDT_HHsvfit_abs_deltaPhi = 0;
   BDT_HT20 = 0;
   BDT_HT20_jetup = 0;
   BDT_HT20_jetdown = 0;
   BDT_HT20_jetupTot = 0;
   BDT_HT20_jetdownTot = 0;
   BDT_topPairMasses = 0;
   BDT_topPairMasses2 = 0;
   BDT_MX = 0;
   BDT_bH_tauH_MET_InvMass = 0;
   BDT_bH_tauH_SVFIT_InvMass = 0;
   BDT_bH_tauH_InvMass = 0;
   BDT_total_CalcPhi = 0;
   BDT_ditau_CalcPhi = 0;
   BDT_dib_CalcPhi = 0;
   BDT_MET_tauH_SVFIT_cosTheta = 0;
   BDT_MET_bH_cosTheta = 0;
   BDT_b1_bH_cosTheta = 0;
   BDT_tauH_SVFIT_reson_cosTheta = 0;
   VBFjj_dEtaSign = 0;
   VBFjet2_PUjetID = 0;
   bH_VBF1_deltaEta = 0;
   dib_dEtaSign = 0;
   ...
   if (fChain->GetListOfBranches()->FindObject("met_er_phi"))
     fChain->SetBranchAddress("met_er_phi", &met_er_phi, &b_met_er_phi);
   if (fChain->GetListOfBranches()->FindObject("met_er_et"))
   ...
   if (fChain->GetListOfBranches()->FindObject("HH_mass_raw_tauup"))
   fChain->SetBranchAddress("HH_mass_raw_tauup", &HH_mass_raw_tauup, &b_HH_mass_raw_tauup);
   if (fChain->GetListOfBranches()->FindObject("HH_mass_raw_taudown"))
   ...
   fChain->SetBranchAddress("MT2", &MT2, &b_MT2);
   if (fChain->GetListOfBranches()->FindObject("MT2_tauup"))
   fChain->SetBranchAddress("MT2_tauup", &MT2_tauup, &b_MT2_tauup);
   if (fChain->GetListOfBranches()->FindObject("MT2_taudown"))
   fChain->SetBranchAddress("MT2_taudown", &MT2_taudown, &b_MT2_taudown);
   if (fChain->GetListOfBranches()->FindObject("MT2_jetup"))
   fChain->SetBranchAddress("MT2_jetup", &MT2_jetup, &b_MT2_jetup);
   if (fChain->GetListOfBranches()->FindObject("MT2_jetdown"))
   ...
   if (fChain->GetListOfBranches()->FindObject("VBFjj_mass_log"))
   fChain->SetBranchAddress("VBFjj_mass_log", &VBFjj_mass_log, &b_VBFjj_mass_log);
   if (fChain->GetListOfBranches()->FindObject("jj_mass_log"))
   ...
   if (fChain->GetListOfBranches()->FindObject("DNN_VBFvsGGF_TauTauLoose"))    
   fChain->SetBranchStatus("DNN_VBFvsGGF_TauTauLoose", 1);
   fChain->SetBranchStatus("DNNoutSM_kl_1", 1);
   if (fChain->GetListOfBranches()->FindObject("DNN_VBFvsGGF_TauTauTight"))    
   fChain->SetBranchStatus("DNN_VBFvsGGF_TauTauTight", 1);
   if (fChain->GetListOfBranches()->FindObject("DNN_VBFvsGGF_ETau"))    
   fChain->SetBranchStatus("DNN_VBFvsGGF_ETau", 1);
   if (fChain->GetListOfBranches()->FindObject("DNN_VBFvsGGF_MuTau"))    
   ...
   fChain->SetBranchStatus("dau2_e", 1);
   ...
   fChain->SetBranchStatus("VBFjet2_eta", 1);
   fChain->SetBranchStatus("VBFjet1_phi", 1);
   ...
   fChain->SetBranchStatus("HHsvfit_pt", 1);
   fChain->SetBranchStatus("HHsvfit_phi", 1);
   fChain->SetBranchStatus("HHsvfit_eta", 1);
   fChain->SetBranchStatus("HHsvfit_deltaPhi", 1);
   fChain->SetBranchStatus("HHkinsvfit_eta", 1);
   ...
   fChain->SetBranchStatus("PUReweight", 1);
   fChain->SetBranchStatus("L1pref_weight", 1);
   fChain->SetBranchStatus("trigSF", 1);
   fChain->SetBranchStatus("IdAndIsoAndFakeSF_deep", 1);
   ...
   fChain->SetBranchStatus("dau1_iso", 1);
   fChain->SetBranchStatus("pairType", 1);
